  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      ...
      <form onSubmit={saveBrand} className="space-y-4 rounded-2xl border border-gray-100 bg-white p-6">
        ...
        <button type="submit" disabled={savingBrand} className="rounded-full bg-brand px-4 py-2 text-sm font-medium text-white disabled:opacity-60">
      ...
      <div className="space-y-4 rounded-2xl border border-gray-100 bg-white p-6">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => setShowAddBranch(true)} className="rounded-full bg-brand px-3 py-1.5 text-xs font-medium text-white">
            + Add branch
          </button>
        </div>
        {loading ? (
      ...
      <div className="space-y-4 rounded-2xl border border-gray-100 bg-white p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {vendorCsv && (
              <button onClick={uploadVendorCsv} className="rounded-lg bg-gray-900 px-3 py-1.5 text-xs text-white">
                Import
              </button>
            )}
            <button onClick={() => setShowAddVendor(true)} className="rounded-full bg-brand px-3 py-1.5 text-xs font-medium text-white">
              + Add vendor
            </button>
          </div>
        </div>
                  ...
                  phoneEditingId === v.id ? (
                    <span className="ml-2 inline-flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="rounded-full bg-brand px-2 py-1 text-xs font-medium text-white disabled:opacity-60"
                      >
      ...
      <div className="space-y-4 rounded-2xl border border-gray-100 bg-white p-6">
        <div className="flex items-center justify-between">
          <h2 className="text-base font-semibold text-gray-900">Item master</h2>
          <div className="flex items-center gap-2">
            ...
            {itemCsv && (
              <button onClick={uploadItemCsv} className="rounded-lg bg-gray-900 px-3 py-1.5 text-xs text-white">
                Import
              </button>
            )}
          </div>
